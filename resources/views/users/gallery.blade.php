...
<head>
    ...
    <link rel="stylesheet" href="/user/css/gallery.css">
            ...
            <div class="container">
                <div class="directory-active row">
                    ...
                    <div class="properties pb-20 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="50">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="album.php"><img src="/user/img/slide1.jpg" alt="" height="210" width="300"></a>
                                <div class="img-text">
                                    <span>28-02-2020</span>
                                    <!--<span>Closed</span>-->
                                </div>
                                <div class="icon">
                                    <img src="/user/img/categori_icon1.png" alt=""> 
                                </div>
                            </div>
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name col-lg-12">
                                    <span><h5 style="float:left;line-height:1.5"><i class="fa fa-bank pr-2"></i>College Festival</h5><a href="/gallery/album"><button class="btn px-3" style="float:right;background-color:#FDD35F;border-radius:20px;">View</button></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="properties pb-20 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="rankers.php"><img src="/user/img/img_2.jpg" alt="" height="210" width="300"></a>
                                <div class="img-text">
                                    <span>28-02-2020</span>
                                    <!--<span>Closed</span>-->
                                </div>
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name col-lg-12">
                                    <span><h5 style="float:left;line-height:1.5"><i class="fas fa-user-graduate pr-2"></i>Our Winners</h5><a href="/gallery/rankers"><button class="btn px-3" style="float:right;background-color:#FDD35F;border-radius:20px;">View</button></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="properties pb-20 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="150">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="youtube.php"><img src="/user/img/img_1.jpg" alt=""></a>
                                <div class="img-text">
                                    <span>28-02-2020</span>
                                    <!--<span>Closed</span>-->
                                </div>
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name col-lg-12">
                                    <span><h5 style="float:left;line-height:1.5"><i class="fab fa-youtube pr-2"></i>Youtube Videos</h5><a href="/gallery/youtube"><button class="btn px-3" style="float:right;background-color:#FDD35F;border-radius:20px;">View</button></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
